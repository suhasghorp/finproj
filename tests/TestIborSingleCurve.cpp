...
TEST_CASE( "test_ibor_single_curve", "[single-file]" ){
  ...
  auto depo = IborDeposit(settlement_date, maturity_date, deposit_rate, depoDCCType);
  depos.push_back(depo);

  //Futures
  std::vector<IborFuture> futs{};
  auto fut = IborFuture(val_date, 1);
  futs.push_back(fut);
  fut = IborFuture(val_date, 2);
  futs.push_back(fut);
  fut = IborFuture(val_date, 3);
  futs.push_back(fut);
  fut = IborFuture(val_date, 4);
  futs.push_back(fut);
  fut = IborFuture(val_date, 5);
  futs.push_back(fut);
  fut = IborFuture(val_date, 6);
  futs.push_back(fut);
  ...
  swaps.push_back(IborSwap(settlement_date, "2Y", fixed_leg_type,(2.77417 + 2.77844) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "3Y", fixed_leg_type,(2.86098 + 2.86582) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "4Y", fixed_leg_type,(2.90240 + 2.90620) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "5Y", fixed_leg_type,(2.92944 + 2.92906) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "6Y", fixed_leg_type,(2.94001 + 2.94499) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "7Y", fixed_leg_type,(2.95352 + 2.95998) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "8Y", fixed_leg_type,(2.96830 + 2.97400) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "9Y", fixed_leg_type,(2.98403 + 2.98817) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "10Y", fixed_leg_type,(2.99716 + 3.00394) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "11Y", fixed_leg_type,(3.01344 + 3.01596) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "12Y", fixed_leg_type,(3.02276 + 3.02684) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "15Y", fixed_leg_type,(3.04092 + 3.04508) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "20Y", fixed_leg_type,(3.04417 + 3.05183) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "25Y", fixed_leg_type,(3.03219 + 3.03621) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "30Y", fixed_leg_type,(3.01030 + 3.01370) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "40Y", fixed_leg_type,(2.96946 + 2.97354) / 200, freq, accrual));
  swaps.push_back(IborSwap(settlement_date, "50Y", fixed_leg_type,(2.91552 + 2.93748) / 200, freq, accrual));
