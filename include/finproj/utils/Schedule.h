...
class Schedule {
 ...
 public:
  ...
  Schedule& withCalendar(Calendar calendar){calendar_ = calendar; return *this;}
 ...
 private:
  Schedule(const ChronoDate &eff_date, const ChronoDate &term_date, FrequencyTypes types) : eff_date_{eff_date}, term_date_{term_date}{};
  void generate();
